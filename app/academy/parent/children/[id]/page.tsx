...
interface OverviewData {
  ...
  paths: {
    memorization: { title: string; progress_percentage: number; total_courses: number } | null
    tajweed: { title: string; progress_percentage: number; total_courses: number } | null
  }
            ...
            <Card className="rounded-2xl bg-emerald-50 dark:bg-emerald-950/30 border-emerald-200">
              <CardContent className="p-5">
                ...
                <div className="text-sm text-muted-foreground mt-1">
                  {Math.round(overview.paths.memorization.progress_percentage)}%
                </div>
              </CardContent>
            </Card>
          )}
          {overview.paths.tajweed && (
            <Card className="rounded-2xl bg-blue-50 dark:bg-blue-950/30 border-blue-200">
              <CardContent className="p-5">
                ...
                <div className="text-sm text-muted-foreground mt-1">
                  {Math.round(overview.paths.tajweed.progress_percentage)}%
                </div>
              </CardContent>
            </Card>
          )}
