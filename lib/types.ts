...
export type PointsAction = 'recitation' | 'mastered' | 'task' | 'lesson' | 'streak' | 'juz_complete' | 'course_complete' | 'session_attend' | 'daily_login' | 'competition_win' | 'badge_earned' | 'admin_adjust'
